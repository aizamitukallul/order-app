								...
								<table id="example2" class="table table-striped table-bordered">
									...
									<tbody>
										<?php 					
											...
											//Delete all unwanted rows from the tables
											$query_del = "DELETE FROM goodsreceivedetail WHERE ProductCode=''";
											$result_del = mysqli_query($link,$query_del);
											$query_del1 = "DELETE FROM stock WHERE ProductCode=''";
											$result_del1 = mysqli_query($link,$query_del1);
											
											
											$query = "SELECT T1.GoodsReceiveID,T1.SupplierCode,T1.SupplierInvoice,T1.ReceiveDate,
															SUM(T2.UnitPrice*T2.ReceiveQTY) AS totalprice
													FROM goodsreceivemaster T1
													  INNER JOIN goodsreceivedetail T2 ON T1.GoodsReceiveID = T2.GoodsReceiveID
													  GROUP BY T1.SupplierInvoice;";
