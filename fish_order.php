	...
	<div class="wrapper">
		...
		<main class="page-content">
			...
			<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
				<div class="breadcrumb-title pe-3">Fish</div>
				<div class="ps-3">
			...
			<div class="row">
				<div class="col-xl-10 mx-auto">					
					<hr/>
					<form action="insert_fishinvoice.php" method="post" accept-charset="utf-8">	
					<div class="card">
						<div class="card-body">
							<div class="border p-4 rounded">								
								<?php
									$query = "SELECT InvoiceID,InvoiceNo from orderinvoicemaster order by InvoiceID DESC LIMIT 1";
									...
									<div class="col-sm-9">
										...
										<table class="table table-bordered">
											...
											<tr>
												...
												<td><input type="text" name="UnitPrice[]" style="width: 90%" value="0.0" readonly></td>
												<td><input type="text" name="UnitIVA[]" style="width: 90%" value="0.0" readonly></td>
