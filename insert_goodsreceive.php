<?php
	...
	if(mysqli_num_rows($result_duplicate) >0 ){
		...
		for ($j = 0; $j < $rowCount; $j++) {
			$sql3 = "INSERT INTO `stock` (`StockID`, `StockReceiveDateTime`, `ProductCode`, `GoodReceiveQTY`, `OrderInvoiceDateTime`, `OrderInvoiceQTY`, `OpeningBalance`, `CurrentBalance`, `StockNotes`) VALUES (NULL, '$ReceiveDate', '$ProductCode1[$j]', '$ReceiveQTY1[$j]', NULL, NULL, '0', '0', 'Good_Receive');";
