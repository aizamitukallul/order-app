								...
								<table class="table align-middle">
									...
									<tbody>
										<?php 
											...
											$totalqty =0;
											$userid = $_SESSION['login_user']; 												
											$query = "SELECT T1.InvoiceID,T1.ProductCode,T1.UnitPrice,T1.UnitIVA,T1.SalesQTY,(T1.UnitPrice*T1.SalesQTY) AS totalprice
													FROM orderinvoicedetails T1
										...
										<tr>
											...
											<td><?php echo $row['SalesQTY']; $totalqty += $row['SalesQTY']; ?></td>
