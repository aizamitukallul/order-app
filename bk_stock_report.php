					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex align-items-center">
								...
								<form class="ms-auto position-relative" onsubmit='$("#datatodisplay").val( $("<div>").append( $("#services_detail").eq(0).clone()).html() )'>
									<input type="hidden" id="datatodisplay" name="datatodisplay"/>
									<input class="btn btn-primary" type="submit" value="Export"/>									
								</form>
							</div>
							<div class="table-responsive mt-3" id="services_detail">
