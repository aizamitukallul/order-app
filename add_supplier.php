		...
		<main class="page-content">
			...
			<div class="row">
				<div class="col-xl-10 mx-auto">					
					<hr/>
					<form action="insert_supplier.php" method="post" class="form-horizontal" accept-charset="utf-8">	
					<div class="card">
						<div class="card-body">
							<div class="border p-4 rounded">								
								<div class="row mb-3">
									<label for="SupplierCode" class="col-sm-3 col-form-label">Supplier Code</label>
									<div class="col-sm-4">
								...
								<div class="row mb-3">
									<label for="SupplierAddress" class="col-sm-3 col-form-label">Address</label>
									<div class="col-sm-4">
